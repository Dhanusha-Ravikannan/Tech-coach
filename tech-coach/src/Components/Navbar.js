...
//          <div className='nav'> 
//             <button onClick={book}  className='sett'> <FontAwesomeIcon icon={faChartArea} /> Dashboard </button> 
//             <button className='sett'><FontAwesomeIcon icon={faFileCircleQuestion} /> Decision </button>
//             <button onClick={skill} className='sett'><FaBook /> Guide </button>
//             <button onClick={circle} className='sett'> <IoIosRefreshCircle />Inner Circle </button>
//             <button onClick={notify} className='sett'><FontAwesomeIcon icon={faBell} /> Notifications </button>
//             <button onClick={board} className='sett'> <FontAwesomeIcon icon={faUser} />  Profile </button>  
//           </div>
//     </section>
